...
public class EchoOfNatureAction extends AbstractGameAction {
	...
	public EchoOfNatureAction(AbstractPlayer p, AbstractMonster m, int damage, int block, DamageType damageTypeForTurn, boolean freeToPlayOnce, int energyOnUse) {
		this.p = p;
		this.m = m;
		this.damage = damage;
		this.block = block;
