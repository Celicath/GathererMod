...
public class InvestigateAction extends AbstractGameAction {
	private static final UIStrings uiStrings = CardCrawlGame.languagePack.getUIString("Gatherer:InvestigateAction");
	public static final String[] TEXT = uiStrings.TEXT;
	private AbstractPlayer p;

	CardGroup tmpGroup;

	public InvestigateAction(int amount) {
