...
import the_gatherer.cards.RainbowPower;

import java.util.HashSet;

public class RainbowPowerPower extends AbstractPower {
	...
	public RainbowPowerPower(int power) {
		this.name = NAME;
		this.ID = POWER_ID;
