...
public class FloralFalling extends CustomCard {
	private static final String RAW_ID = "FloralFalling";
	...
	private String GetRawDescription() {
		return (timesUpgraded == 3 ? UPGRADE_DESCRIPTION : DESCRIPTION) + GathererCardHelper.FloralSuffix(timesUpgraded);
	}
