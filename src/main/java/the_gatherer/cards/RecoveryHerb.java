...
public class RecoveryHerb extends CustomCard {
	...
	public void use(AbstractPlayer p, AbstractMonster m) {
		if (this.upgraded)
			AbstractDungeon.actionManager.addToBottom(new ObtainLesserPotionAction(new RecoveryPotionPlus()));
		else
			AbstractDungeon.actionManager.addToBottom(new ObtainLesserPotionAction(new RecoveryPotion()));
	}
